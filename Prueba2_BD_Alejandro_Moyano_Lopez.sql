...
--Pregunta 3: Consulta que actualice el campo cantidad sumándole 10 a los equipos de marca Dell del año 2018.
SELECT * FROM equipo;
...
--Pregunta 5: Consulta que elimine el registro con la generación más baja de la marca HP y Lenovo.
SELECT * FROM equipo;
...
--Pregunta 7: Consulta que muestre la marca y la suma de la cantidad de equipos, con la condición de que muestre solo las marcas que tienen más de 20 equipos.
